...
final class EventDecodingTests: XCTestCase, FixtureLoading {
    ...
    func testDecodeDateBasedCalendarEvent() throws {
        ...
        XCTAssertEqual(event.start, DateComponents(calendar: Calendar(identifier: .iso8601), year: 2023, month: 3, day: 19))
        XCTAssertEqual(event.end, DateComponents(calendar: Calendar(identifier: .iso8601), year: 2023, month: 3, day: 21))
    ...
    func testDecodeTimeBasedCalendarEvent() throws {
        ...
        XCTAssertEqual(event.start, Date(timeIntervalSince1970: 1679062500))
        XCTAssertEqual(event.end, Date(timeIntervalSince1970: 1679067720))
